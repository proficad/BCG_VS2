// BCG_VS2.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CBCG_VS2App, CBCGPWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBCG_VS2App::OnAppAbout)
...
// CBCG_VS2App construction

CBCG_VS2App::CBCG_VS2App()
{
...
// The one and only CBCG_VS2App object

CBCG_VS2App theApp;
CBCGPOccManager theOccManager;


// CBCG_VS2App initialization

BOOL CBCG_VS2App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_BCGVS2TYPE,
		RUNTIME_CLASS(CBCG_VS2Doc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CBCG_VS2View));
	if (!pDocTemplate)
		return FALSE;
...
// CBCG_VS2App message handlers

int CBCG_VS2App::ExitInstance()
{
...
BOOL CBCG_VS2App::SaveAllModified()
{
